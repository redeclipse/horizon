...
OutFile "horizon_20YY_MM_DD_foo_edition_windows.exe"
...
Section "Start Menu Shortcuts"
  ...
  CreateShortCut "$INSTDIR\Tesseract.lnk"                "$INSTDIR\horizon.bat" "" "$INSTDIR\bin\horizon.exe" 0 SW_SHOWMINIMIZED
  CreateShortCut "$SMPROGRAMS\Tesseract\Tesseract.lnk"   "$INSTDIR\horizon.bat" "" "$INSTDIR\bin\horizon.exe" 0 SW_SHOWMINIMIZED
