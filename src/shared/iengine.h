...
extern bool bounce(physent *d, float secs, float elasticity, float watercoast, float grav);
extern bool bounce(physent *d, float elasticity, float watercoast, float grav);
