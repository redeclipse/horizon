...
appfiles=http://redeclipse.net/horizon/stable
...
torrent-webseed-baseurl="http://redeclipse.net/horizon/releases"

OSX_APP=
ifeq ($(APPNAME),horizon)
...
../$(tarname).bz2.torrent: ../$(tarname).bz2
	...
	cd ../ &&\
		...
		-n $(tarname).bz2 \
		-c "Red Eclipse Horizon $(appversion) for GNU/Linux" \
		$(tarname).bz2
