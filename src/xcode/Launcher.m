...
- (void)findPaths
{
    ...
    // userpath: directory where user files are kept - typically /Users/<name>/Application Support/horizon
    path = nil;
...
// plist registers 'horizon' as a url scheme
